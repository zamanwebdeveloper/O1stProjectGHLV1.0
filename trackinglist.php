...
<table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td><strong>:</strong></td>
    <td height="14" class="tabfontfocus"><input name="mobile" type="text" value="<?php echo $_REQUEST['mobile'];?>" size="20"></td>
     <td class="p01quote">Destination</td>
    <td class="tabfontfocus"><strong>:</strong></td>
    <td height="14" class="tabfontfocus"><input name="destination" type="text" value="<?php echo $_REQUEST['destination'];?>" size="20"></td>
...
<base target="mainFrame">
  <?php
	...
	if($_REQUEST['mobile']){
		...
		$ext.=" AND TRIM(smobile)='".trim($_REQUEST['mobile'])."'";
	}
	if($_REQUEST['destination']){
		$ext.=" AND TRIM(destination)='".trim($_REQUEST['destination'])."'";
	}
